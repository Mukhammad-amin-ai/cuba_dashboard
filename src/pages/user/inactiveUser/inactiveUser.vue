<template >
    ...
    <div class="container-fluid p-20">
        ...
        <div class="row d-flex">
            <RouterLink to="inactive-user/create" v-if="this.$store.state.create">
            ...
            <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4" v-for="(item, index) in inactiveUser" :key="item.id">
                <RouterLink :to="{ path: 'inactive-user/' + item.id }">
...
export default {
    ...
    methods: {
        getAllUser() {
            this.$store.dispatch('inactiveUser/getInnactiveUsers')
        },
        roleCheck() {
